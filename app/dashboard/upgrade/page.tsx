      ...
      <div className="py-24 sm:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            Supercharge your Medical Reports
          </p>
        </div>
        ...
        <p className="mx-auto mt-6 max-w-2xl px-10 text-center text-lg leading-8 text-gray-600">
          ...
          interacting with your reports, enhancing productivity, and streamlining
          your diagnosis.
        </p>
        ...
        <div className="max-w-md mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 md:max-w-2xl gap-8 lg:max-w-4xl">
          ...
          <div className="ring-1 ring-gray-200 p-8 h-fit pb-12 rounded-3xl">
            ...
            >
              <li className="flex gap-x-3">
                <CheckIcon className="h-6 w-5 flex-none text-yellow-600" />2
                Reports
              </li>
              <li className="flex gap-x-3">
                <CheckIcon className="h-6 w-5 flex-none text-blue-600" />
                Up to 2 messages per document
              </li>
              <li className="flex gap-x-3">
                <CheckIcon className="h-6 w-5 flex-none text-red-600" />
                Try out the AI Medical Diagnosis
              </li>
            </ul>
          </div>
          ...
          <div className="ring-2 ring-red-600 rounded-3xl p-8">
            ...
            <p className="mt-4 text-sm leading-6 text-gray-600">
              Maximize Diagnosis with PRO Features
            </p>
            <p className="mt-6 flex items-baseline gap-x-1">
              <span className="text-4xl font-bold tracking-tight text-gray-900">
                $9.99
            ...
            >
              <li className="flex gap-x-3">
                <CheckIcon className="h-6 w-5 flex-none text-yellow-600" />
                Store upto 20 Reports
              </li>
              <li className="flex gap-x-3">
                <CheckIcon className="h-6 w-5 flex-none text-blue-600" />
              ...
              <li className="flex gap-x-3">
                <CheckIcon className="h-6 w-5 flex-none text-red-600" />
                Up to 100 messages per reports
              </li>
              <li className="flex gap-x-3">
                <CheckIcon className="h-6 w-5 flex-none text-green-600" />
                Full Power AI Diagnosis Functionality with Memory Recall
              </li>
              <li className="flex gap-x-3">
