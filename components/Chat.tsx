  ...
  return (
    <div className="flex flex-col h-full overflow-scroll">
        ...
        <div className="flex-1 w-full">
            ...
            {loading ? (
                <div className="flex flex-col justify-center">
                    <Loader2Icon className="animate-spin h-20 w-20 text-gray-300 mt-20"/>
                </div>
            ) : (
                <div className="p-5">
                    {messages.length === 0 && (
                        <ChatMessage 
                            ...
                            message={{
                                role: "ai",
                                message: "Ask me anything about the report",
                                createdAt: new Date(),
                            }}
                        />
                    )}
        ...
        <form
            ...
            className="flex sticky bottom-0 space-x-2 p-5 bg-gray-100/75"
        >
            <Input
