...
// gsutil cors set cors.json gs://physician-b5d20.appspot.com 
// go to console.cloud.google.com 
// create file: cors.json
// run on console terminal >>> // gsutil cors set cors.json gs://physician-b5d20.appspot.com 
// Now you will be able to download PDF from google
...
function PdfView({ url }: { url: string }) {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
        ...
        {!file ? (
            <Loader2Icon className="animate-spin h-20 w-20 text-gray-600 mt-20"/>
        ) : (
            <Document
            loading={null}
            file={file}
